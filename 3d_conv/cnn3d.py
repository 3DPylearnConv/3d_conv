...
def evaluate_lenet5(learning_rate=0.001, n_epochs=200,
    ...
    # later parts of the code assume these dimensions are equal
    xdim = 14
    ydim = 14
    zdim = 14
    convsize = 3
    ...
    layer0_input = x.reshape((batch_size, zdim, 1, xdim, ydim))
    ...
    #assumes all three dimensions are the same zdim = xdim = ydim
