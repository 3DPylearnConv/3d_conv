...
from datasets.big_bird_dataset import BigBirdDataset
...
def evaluate(learning_rate=0.001, n_epochs=200,
    ...
    train_dataset = BigBirdDataset()
    test_dataset = BigBirdDataset()
    validation_dataset = BigBirdDataset()
            ...
            if (mini_batch_count + 1) % validation_frequency == 0:
                ...
                if epoch_count > 0:
                    ...
                    for i in xrange(3):
                        ...
                        output = open("../bigBirdShapes/firstrun/shapes%depoch%d.pkl" % (epoch_count, i), 'wb')
