...
class ConvHiddenReconModelConfig():
    ...
    def __init__(self,
        ...
        self.input_shape = (batch_size, zdim/downsample_factor, 1, xdim/downsample_factor, ydim/downsample_factor)
        self.output_shape = (self.input_shape[0], reduce(mul, self.input_shape[1:]))
